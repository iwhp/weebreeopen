...
namespace Telekom.Common.Model
{
    ...
    public class SmsResponseStatus
    {
        ...
        /// <summary>
        /// senderAddress borrowed from the request
        /// </summary>
        [DataMember(Name = "senderAddress")]
        public String senderAddress { get; set; }

        /// <summary>
        /// deliveryInfoList borrowed from the request
        /// </summary>
        [DataMember(Name = "deliveryInfoList")]
        public SmsResponseStatus deliveryInfoList { get; set; }

        /// <summary>
        /// outboundEncoding borrowed from the request
        /// </summary>
        [DataMember(Name = "outboundEncoding")]
        public String outboundEncoding { get; set; }

        /// <summary>
        /// address borrowed from the request
        /// </summary>
        [DataMember(Name = "address")]
        public String[] address { get; set; }

        /// <summary>
        /// outboundSMSTextMessage borrowed from the request
        /// </summary>
        [DataMember(Name = "outboundSMSTextMessage")]
        public SmsResponseMessage outboundSMSTextMessage { get; set; }

        /// <summary>
        /// outboundSMSBinaryMessage borrowed from the request
        /// </summary>
        [DataMember(Name = "outboundSMSBinaryMessage")]
        public SmsResponseMessage outboundSMSBinaryMessage { get; set; }

        /// <summary>
        /// outboundSMSFlashMessage borrowed from the request
        /// </summary>
        [DataMember(Name = "outboundSMSFlashMessage")]
        public SmsResponseMessage outboundSMSFlashMessage { get; set; }
    }
}
